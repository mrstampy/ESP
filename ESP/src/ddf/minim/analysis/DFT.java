...
public class DFT extends FourierTransform {
  /**
   * Constructs a DFT that expects audio buffers of length <code>timeSize</code>
   * that have been recorded with a sample rate of <code>sampleRate</code>. Will
   * throw an IllegalArgumentException if <code>timeSize</code> is not even.
   * 
   * @param timeSize
